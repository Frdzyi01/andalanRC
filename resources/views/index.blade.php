                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-reverse">
                                <ul>
                                    ...
                                    <li>
                                        <a class="dropdown-item nav-link nav_item" href="portfolio-detail-sidemenu-dark.html">portfolio detail sidemenu dark</a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item nav-link nav_item" href="portfolio-detail-sidemenu-white.html">portfolio detail sidemenu white</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a class="dropdown-item nav-link nav_item" href="blog-detail-white.html">blog detail white</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                ...
                <div class="col-md-12">
                    <ul class="grid_container gutter_medium work_col3 portfolio_gallery portfolio_style1 animation" data-animation="fadeInUp" data-animation-delay="0.04s">
                        ...
                        <li class="grid_item web-design">
                            <div class="portfolio_item">
                                <a href="#" class="image_link">
                                    <img src="template/assets/images/portfolio_item_small1.jpg" alt="image" />
                                </a>
                                <div class="portfolio_content">
                                    <div class="link_container">
                                        <a href="template/assets/images/portfolio_item1.jpg" class="image_popup"><i class="ion-image"></i></a>
                                        <a href="#" data-toggle="modal" data-target="#pr_modal"><i class="ion-plus"></i></a>
                                    </div>
                                    <h5>
                                        <a href="#" data-toggle="modal" data-target="#pr_modal">Branded Products</a>
                                    </h5>
                                    <p>Web Design</p>
                                </div>
                            </div>
                        ...
                        <li class="grid_item brands web-design development">
                            <div class="portfolio_item">
                                <a href="#" class="image_link">
                                    <img src="template/assets/images/portfolio_item_small2.jpg" alt="image" />
                                </a>
                                <div class="portfolio_content">
                                    <div class="link_container">
                                        <a href="template/assets/images/portfolio_item2.jpg" class="image_popup"><i class="ion-image"></i></a>
                                        <a href="#" data-toggle="modal" data-target="#pr_modal"><i class="ion-plus"></i></a>
                                    </div>
                                    <h5>
                                        <a href="#" data-toggle="modal" data-target="#pr_modal">Visiting Card</a>
                                    </h5>
                        ...
                        <li class="grid_item brands web-design">
                            <div class="portfolio_item">
                                <div class="carousel_slider owl-carousel owl-theme dots_white" data-autoplay="true" data-loop="false" data-animate-in="fadeIn" data-animate-out="fadeOut" data-autoplay-timeout="3000" data-items="1">
                                    <a href="#" class="image_link">
                                        <img src="template/assets/images/portfolio_item_small3.jpg" alt="image" />
                                    </a>
                                    <a href="#" class="image_link">
                                        <img src="template/assets/images/portfolio_item_small4.jpg" alt="image" />
                                    </a>
                                </div>
                                <div class="portfolio_content">
                                    <div class="link_container">
                                        <a href="template/assets/images/portfolio_item3.jpg" class="image_popup"><i class="ion-images"></i></a>
                                        <a href="template/assets/images/portfolio_item4.jpg" class="image_popup d-none"></a>
                                        <a href="#" data-toggle="modal" data-target="#pr_modal"><i class="ion-plus"></i></a>
                                    </div>
                                    <h5>
                                        <a href="#" data-toggle="modal" data-target="#pr_modal">Coffee Cup Mockup</a>
                                    </h5>
                        ...
                        <li class="grid_item brands development">
                            <div class="portfolio_item">
                                <a href="#" class="image_link">
                                    <img src="template/assets/images/portfolio_item_small5.jpg" alt="image" />
                                </a>
                                <div class="portfolio_content">
                                    <div class="link_container">
                                        <a href="template/assets/images/portfolio_item5.jpg" class="image_popup"><i class="ion-image"></i></a>
                                        <a href="#" data-toggle="modal" data-target="#pr_modal"><i class="ion-plus"></i></a>
                                    </div>
                                    <h5>
                                        <a href="#" data-toggle="modal" data-target="#pr_modal">Letter Design</a>
                                    </h5>
                        ...
                        <li class="grid_item brands web-design development">
                            <div class="portfolio_item">
                                <a href="#" class="image_link">
                                    <img src="template/assets/images/portfolio_item_small6.jpg" alt="image" />
                                </a>
                                <div class="portfolio_content">
                                    <div class="link_container">
                                        <a href="template/assets/images/portfolio_item6.jpg" class="image_popup"><i class="ion-image"></i></a>
                                        <a href="#" data-toggle="modal" data-target="#pr_modal"><i class="ion-plus"></i></a>
                                    </div>
                                    <h5>
                                        <a href="#" data-toggle="modal" data-target="#pr_modal">Branding Cap</a>
                                    </h5>
                                    <p>Branding, Web Design, Development</p>
                                </div>
                            </div>
                        ...
                        <li class="grid_item brands web-design development">
                            <div class="portfolio_item">
                                <a href="#" class="image_link">
                                    <img src="template/assets/images/portfolio_item_small7.jpg" alt="image" />
                                </a>
                                <div class="portfolio_content">
                                    <div class="link_container">
                                        <a href="template/assets/images/portfolio_item7.jpg" class="image_popup"><i class="ion-image"></i></a>
                                        <a href="#" data-toggle="modal" data-target="#pr_modal"><i class="ion-plus"></i></a>
                                    </div>
                                    <h5>
                                        <a href="#" data-toggle="modal" data-target="#pr_modal">Branding Cream</a>
                                    </h5>
                                    <p>Branding, Web Design, Development</p>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="carousel_slider owl-carousel owl-theme" data-margin="20" data-dots="false" data-loop="true" data-nav="true" data-autoplay="true" data-items="1">
                                    <div class="item">
                                        <img src="template/assets/images/portfolio_img1.jpg" alt="portfolio_img1" />
                                    </div>
                                    <div class="item">
                                        <img src="template/assets/images/portfolio_img2.jpg" alt="portfolio_img2" />
                                    </div>
                                    <div class="item">
                                        <img src="template/assets/images/portfolio_img3.jpg" alt="portfolio_img3" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <ul class="list_none portfolio_info_box">
                                    ...
                                    <li>
                                        <span class="text-uppercase">PROJECT link</span>www.sitename.com
                                    </li>
                                    <li>
